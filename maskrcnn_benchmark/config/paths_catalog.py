...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "VG_stanford_filtered": {
            "img_dir": datasets_path+"vg/VG_100K",
            "roidb_file": datasets_path+"vg/VG-SGG.h5",
            "dict_file": datasets_path+"vg/VG-SGG-dicts.json",
            "image_file": datasets_path+"vg/image_data.json",
        },
        "VG_stanford_filtered_with_attribute": {
            "img_dir": datasets_path+"vg/VG_100K",
            "roidb_file": datasets_path+"vg/VG-SGG-with-attri.h5",
            "dict_file": datasets_path+"vg/VG-SGG-dicts-with-attri.json",
            "image_file": datasets_path+"vg/image_data.json",
        },
    }
